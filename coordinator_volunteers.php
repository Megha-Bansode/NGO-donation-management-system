            ...
            if ($reg_id && in_array($status, ['pending', 'approved', 'rejected'])) {
                try {
                    ...
                    if ($owner_id != $_SESSION['user_id']) {
                        $error_msg = "You do not have permission to manage this volunteer.";
                    } else {
        ...
        <div class="page-content">
            ...
            <div class="glass-card" style="margin-bottom: 20px;">
                <form method="GET" action="coordinator_volunteers.php" class="filter-bar">
                    ...
                    <a href="coordinator_volunteers.php" class="btn-primary" style="padding: 10px 20px; background: rgba(0,0,0,0.05); color: var(--text-dark); text-decoration: none;"><i class="fas fa-undo"></i> Reset</a>
                </form>
            </div>

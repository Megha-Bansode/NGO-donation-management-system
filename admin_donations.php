    ...
    <main class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="glass-card" style="margin-bottom: 20px;">
                <form method="GET" action="admin_donations.php" class="filter-bar">
                    ...
                    <a href="admin_donations.php" class="btn-primary" style="padding: 10px 20px; background: rgba(0,0,0,0.05); color: var(--text-dark); text-decoration: none;"><i class="fas fa-undo"></i> Reset</a>
                </form>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 8px;">
                                            <button onclick='openDetailsModal(<?php echo json_encode($don); ?>)' class="action-btn" style="width: 32px; height: 32px;" title="View Details">
